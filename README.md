...
Além da matriz de confusão, **confusão.py** gera um relatório de erros em HTML. Você pode conferir um exemplo clicando [aqui](http://tronco.me/acdc-ud/matriz/teste.html).
